  ...
  return (
    <div className="container">
      <div className="row no-gutters">
        <div className="col-md-4 border-right resize-horizontal">
          ...
          <div className="friend-drawer friend-drawer--onhover active">
            <img
              className="profile-image"
          ...
          <hr />
          <div className="friend-drawer friend-drawer--onhover active-user">
            <img
              className="profile-image"
        ...
        <div className="col-md-8">
          <div className="settings-tray">
            <div className="friend-drawer no-gutters friend-drawer--grey">
              ...
              />
              <div className="text">
                <h6 id="person-name">Optimus</h6>
                <p className="text-muted" id="last-seen">
                  Last seen recently
                </p>
              </div>
              <span className="settings-tray--right">
